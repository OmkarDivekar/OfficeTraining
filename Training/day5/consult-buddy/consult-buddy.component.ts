...
@Component({
  selector: 'app-consult-buddy',
  templateUrl: './consult-buddy.component.html',
  styleUrls: ['./consult-buddy.component.css']
})
export class ConsultBuddyComponent implements OnInit {
  form!: FormGroup;
  dataSource: any;
  stateData: any;
  countryData: any;
